...
public class GenericParameterKeyTests
{
    ...
    {
        var common = ParameterKey.CreateKey<int>("Param", string.Empty);
    ...
    {
        var key1 = ParameterKey.CreateKey<int>("Param1", string.Empty);
        var key2 = ParameterKey.CreateKey<int>("Param1", string.Empty);
    ...
    {
        var key1 = ParameterKey.CreateKey<int>("Param1", string.Empty);
        var key2 = ParameterKey.CreateKey<int>("Param2", string.Empty);
    ...
    {
        var key1 = ParameterKey.CreateKey<int>("Param1", "Display 1");
        var key2 = ParameterKey.CreateKey<int>("Param1", "Display 2");
    ...
    {
        var key1 = ParameterKey.CreateKey<int>("Param1", "Display 1");
        var key2 = ParameterKey.CreateKey<int>("Param2", "Display 2");
    ...
    {
        IParameterKey key1 = ParameterKey.CreateKey<int>("Param1", "Display 1");
        IParameterKey key2 = ParameterKey.CreateKey<int>("Param1", "Display 2");
    ...
    {
        IParameterKey key1 = ParameterKey.CreateKey<int>("Param1", "Display 1");
        IParameterKey key2 = ParameterKey.CreateKey<int>("Param2", "Display 2");
